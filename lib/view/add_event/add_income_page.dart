...
class AddIncomePage extends StatefulHookConsumerWidget {
...
class _AddIncomePageState extends ConsumerState<AddIncomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final incomeCategory = useState('未分類');
    final incomePaymentUser = useState(model.name);
                  ...
                  children: [
                    ...
                    ListTile(
                      title: DropdownButton<String>(
                        ...
                        items: model.incomeCategoryList
                    ...
                    ListTile(
                      title: DropdownButton<String>(
                        ...
                        onChanged: (String? value) {
                          ...
                          ref
                              .read(addEventViewModelProvider)
                              .setIncomePaymentUser(value);
                        },
                        items: model.incomePaymentUserList
                            .map<DropdownMenuItem<String>>((String value) {
                          return DropdownMenuItem<String>(
                            value: value,
                            child: Text(value),
