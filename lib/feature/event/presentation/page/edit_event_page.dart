...
class EditEventPage extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
            ...
            actions: [
              ...
              TextButton(
                ...
                onPressed: () async {
                  try {
                    await EventFire()
                        .deleteEventFire(ref.watch(roomCodeProvider), event.id);
                    await updateEventState(ref,
    ...
    return Scaffold(
      appBar: CustomAppBar(title: '${event.largeCategory}の編集'),
      body: SafeArea(
