...
Icon viewIcon(String category) {
  switch (category) {
    case '給与':
      return const Icon(Icons.account_balance_wallet, color: Color(0xFFffd700), size: 30);
    case '賞与':
    ...
    case '日用雑貨費':
      return const Icon(Icons.shopping_cart, color: Color(0xFFdeb887), size: 30);
    case '交通・車両費':
      return const Icon(Icons.directions_car_outlined, color: Color(0xFFb22222), size: 30);
    case '住居費':
      return const Icon(Icons.house, color: Color(0xFFf4a460), size: 30);
    case '光熱費(電気)':
      return const Icon(Icons.bolt, color: Color(0xFFf0e68c), size: 30);
    case '光熱費(ガス)':
      return const Icon(Icons.local_fire_department, color: Color(0xFFdc143c), size: 30);
    case '水道費':
      return const Icon(Icons.water_drop, color: Color(0xFF00bfff), size: 30);
    case '通信費':
      return const Icon(Icons.speaker_phone, color: Color(0xFFff00ff), size: 30);
    case 'レジャー費':
    ...
    case '医療費':
      return const Icon(Icons.local_hospital_outlined, color: Color(0xFFff7f50), size: 30);
    case 'ファッション費':
